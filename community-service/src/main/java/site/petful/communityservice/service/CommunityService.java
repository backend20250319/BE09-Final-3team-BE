...
public class CommunityService {
    ...
    public PostDto registNewPost(Long userId, PostCreateRequest request) {
        Post saved = communityRepository.save(new Post(userId, request.getTitle(),request.getContent(),request.getType()));
