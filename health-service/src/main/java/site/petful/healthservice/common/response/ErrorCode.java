...
public enum ErrorCode {
    ...
    // 활동 관리 관련 에러 코드 (7000번대)
    ACTIVITY_NOT_FOUND("7076", "해당 활동 데이터가 존재하지 않습니다."),
    ACTIVITY_FORBIDDEN("7077", "해당 활동 데이터에 대한 접근 권한이 없습니다."),
    PET_NOT_OWNED("7078", "해당 펫에 대한 접근 권한이 없습니다."),
    INVALID_ACTIVITY_DATA("7079", "활동 데이터가 유효하지 않습니다."),
    INVALID_MEAL_DATA("7080", "식사 데이터가 유효하지 않습니다."),
    ACTIVITY_DATE_INVALID("7081", "활동 날짜가 유효하지 않습니다."),
    WALKING_DISTANCE_INVALID("7082", "산책 거리가 유효하지 않습니다."),
    WEIGHT_INVALID("7083", "무게가 유효하지 않습니다."),
    SLEEP_HOURS_INVALID("7084", "수면 시간이 유효하지 않습니다."),
    POOP_COUNT_INVALID("7085", "대변 횟수가 유효하지 않습니다."),
    PEE_COUNT_INVALID("7086", "소변 횟수가 유효하지 않습니다."),
    MEAL_WEIGHT_INVALID("7087", "식사 무게가 유효하지 않습니다."),
    MEAL_CALORIES_INVALID("7088", "식사 칼로리가 유효하지 않습니다."),
    ACTIVITY_LEVEL_INVALID("7089", "활동 계수가 유효하지 않습니다."),
    PERIOD_TYPE_INVALID("7090", "기간 타입이 유효하지 않습니다."),
    DATE_RANGE_INVALID("7091", "날짜 범위가 유효하지 않습니다."),
    ACTIVITY_CREATION_FAILED("7092", "활동 데이터 생성에 실패했습니다."),
    ACTIVITY_UPDATE_FAILED("7093", "활동 데이터 수정에 실패했습니다."),
    ACTIVITY_DELETION_FAILED("7094", "활동 데이터 삭제에 실패했습니다."),
    MEAL_UPDATE_FAILED("7095", "식사 정보 수정에 실패했습니다."),
    CALORIES_CALCULATION_FAILED("7096", "칼로리 계산에 실패했습니다."),
    ACTIVITY_SCHEDULE_NOT_FOUND("7097", "활동 스케줄을 찾을 수 없습니다."),
    PET_PROFILE_NOT_FOUND("7098", "펫 프로필을 찾을 수 없습니다."),
    USER_PETS_NOT_FOUND("7099", "사용자의 펫 목록을 찾을 수 없습니다."),
    ACTIVITY_CHART_DATA_FAILED("7100", "활동 차트 데이터 생성에 실패했습니다."),
    ACTIVITY_AGGREGATION_FAILED("7101", "활동 데이터 집계에 실패했습니다."),
    INVALID_MEAL_TYPE("7102", "유효하지 않은 식사 타입입니다."),
    MEAL_DELETION_FAILED("7103", "식사 정보 삭제에 실패했습니다."),
    ACTIVITY_MEAL_RELATIONSHIP_ERROR("7104", "활동과 식사 정보 간의 관계 오류가 발생했습니다."),
    ACTIVITY_DATA_INTEGRITY_ERROR("7105", "활동 데이터 무결성 오류가 발생했습니다."),
