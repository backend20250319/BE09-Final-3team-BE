...
public enum FrequencyConversion {
    ...
    public static final String DAILY_FREQUENCY_PATTERN = "하루(?:에)?\\s*(\\d+)(?:번|회)";
    public static final String WEEKLY_FREQUENCY_PATTERN = "주(?:에)?\\s*(\\d+)(?:번|회)";
    public static final String MONTHLY_FREQUENCY_PATTERN = "월(?:에)?\\s*(\\d+)(?:번|회)";
